...
def validate_ci_runs_core_checks() -> None:
    ...
    required = [
        ...
        "scripts/install_skill.py --agent all --home /tmp/loop-paper-home-all",
        "/tmp/loop-paper-home-all/.agents/skills/loop-paper",
        "/tmp/loop-paper-home-all/.claude/skills/loop-paper",
        "/tmp/loop-paper-home-all/.codex/skills/loop-paper",
        "/tmp/loop-paper-home-all/.hermes/skills/loop-paper",
        "/tmp/loop-paper-home-all/.openclaw/skills/loop-paper",
        "/tmp/loop-paper-home-all/.pimo/skills/loop-paper",
